...
router.put("/:id/members", requireRole(["ADMIN", "MANAGER"]), updateTeamMembers);
router.put("/:id/projects", requireRole(["ADMIN", "MANAGER"]), assignProjectsToTeam);
router.put("/:id/tasks", requireRole(["ADMIN", "MANAGER"]), assignTasksToTeam);
