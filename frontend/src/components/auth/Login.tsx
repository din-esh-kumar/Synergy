...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Welcome message
      const welcomeMsg = response.data.isNew
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#181f32]">
      ...
      >
        ...
        <h2 className="text-white text-2xl font-black text-center mb-1">Log in to your account</h2>
        ...
        <div>
          <label className="block mb-1 text-[#b0b8cb] text-xs font-semibold">Email Address</label>
          <input
        ...
        <div>
          <label className="block mb-1 text-[#b0b8cb] text-xs font-semibold">Password</label>
          <input
            className="block w-full bg-[#181f32] text-white rounded-lg border border-[#25304d] focus:ring-blue-500 py-2 px-3 placeholder-[#586279] outline-none"
            type="password"
            name="password"
        ...
        <div className="flex justify-end">
          <span className="text-blue-500 text-xs hover:underline cursor-pointer">Forgot your password?</span>
        </div>
        <button
          type="submit"
        ...
        >
          <span className="material-symbols-outlined">account_circle</span> Sign in with Google
        </button>
        <button
          type="button"
          className="w-full py-2 bg-[#262e3f] text-white font-semibold rounded-lg flex items-center justify-center gap-2"
        >
          <span className="material-symbols-outlined">account_circle</span> Sign in with Microsoft
        </button>
