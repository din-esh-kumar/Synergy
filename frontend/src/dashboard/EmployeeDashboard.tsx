  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <StatCard icon={CheckSquare} label="My Tasks" value={stats.myTasks} color="bg-blue-600" />
        <StatCard icon={Briefcase} label="My Projects" value={stats.myProjects} color="bg-indigo-600" />
        <StatCard icon={Calendar} label="My Meetings" value={stats.myMeetings} color="bg-green-600" />
      </div>
